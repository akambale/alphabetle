    ...
    <div className='text-white mb-4 flex items-center justify-center gap-2'>
      ...
      <div className='group relative'>
        <svg
          ...
          className='h-5 w-5 text-gray-400 cursor-help touch-manipulation peer'
          fill='none'
          viewBox='0 0 24 24'
          stroke='currentColor'
          tabIndex={0}
        ...
        <div className='absolute top-full left-1/2 -translate-x-1/2 mt-2 w-72 p-3 bg-gray-800 rounded-lg shadow-lg opacity-0 invisible transition-all duration-200 [@media(hover:hover)]:group-hover:opacity-100 [@media(hover:hover)]:group-hover:visible [@media(hover:none)]:peer-focus:opacity-100 [@media(hover:none)]:peer-focus:visible z-10'>
          ...
          <div className='text-sm space-y-2'>
            <p>
              ...
              listing words. Green letters are used once and yellow letters are
              used multiple times.
            </p>
